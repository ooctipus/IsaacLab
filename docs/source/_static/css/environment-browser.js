...
(() => {
    ...
    const initializeEnvironmentBrowser = () => {
        ...
        const taskRows = [
            ...
            ["Isaac-Factory-v0", "rsl_rl", "isaacsim_physx,newton_mjwarp", "", "beta,beta_value_shift,bnc,dil1,dil2,dil3,dil4,dil5,dsub,eval,franka,frontier,gear_mesh_large,gear_mesh_medium,gear_mesh_small,monitor,nut_thread_m12,nut_thread_m16,nut_thread_m4,nut_thread_m8,peg_insert_12mm,peg_insert_16mm,peg_insert_4mm,peg_insert_8mm,rj45,rod_insert_12mm,rod_insert_16mm,rod_insert_4mm,rod_insert_8mm,success_terminate,timeout_terminate,uniform,usba,value_shift,waterproof"],
