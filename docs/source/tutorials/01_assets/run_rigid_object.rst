...
:func:`~isaaclab.cloner.clone_plan_from_env_0` receives the clone policy and explicit asset cfgs,
publishes the plan, and creates the environment origins before the object is constructed through
