...
def _env_cfg_with_locomotion_preset():
    ...
    from isaaclab_tasks.manager_based.multi_task.terrain.mdp_presets.multitask_presets import (
...
def test_gym_task_registers():
    ...
    assert (
        ...
        == "isaaclab_tasks.manager_based.multi_task.multi_task_env_cfg:MultiTaskEnvCfg"
    )
...
def test_commands_cfg_is_multitask():
    ...
    """
    from isaaclab_tasks.manager_based.multi_task.mdp.commands.multitask.multi_task_cfg import MultiTaskCfg
    from isaaclab_tasks.manager_based.multi_task.multi_task_env_cfg import MultiTaskEnvCfg
...
def test_tripod_walk_structure():
    ...
    suffix.
    """
    from isaaclab_tasks.manager_based.multi_task.mdp.commands.multitask.kernels_torch import STATE_KERNEL_ID
    from isaaclab_tasks.manager_based.multi_task.mdp.commands.multitask.multi_task_cfg import MultiTaskCfg
...
def test_default_safety_subtasks_appended_to_every_task():
    ...
    in :mod:`isaaclab_tasks.manager_based.multi_task.terrain.tasks_cfg`.
    """
    from isaaclab_tasks.manager_based.multi_task.mdp.commands.multitask.kernels_torch import STATE_KERNEL_ID
    from isaaclab_tasks.manager_based.multi_task.mdp.commands.multitask.multi_task_cfg import MultiTaskCfg
...
def test_canonical_widths_are_split_by_reach_and_track():
    ...
    from isaaclab_tasks.manager_based.multi_task.mdp.commands.multitask.spec import build_spec
