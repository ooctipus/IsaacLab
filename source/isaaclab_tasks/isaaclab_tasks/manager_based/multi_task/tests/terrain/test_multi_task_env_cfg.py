...
def test_tripod_walk_structure():
    ...
    suffix.
    """
    from isaaclab_tasks.manager_based.multi_task.mdp.commands.impl.kernels_torch import STATE_KERNEL_ID
    from isaaclab_tasks.manager_based.multi_task.mdp.commands.impl.multi_task_cfg import MultiTaskCfg
...
def test_canonical_widths_are_split_by_reach_and_track():
    ...
    from isaaclab_tasks.manager_based.multi_task.mdp.commands.spec import build_spec
