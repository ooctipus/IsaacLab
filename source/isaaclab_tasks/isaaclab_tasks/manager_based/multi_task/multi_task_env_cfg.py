...
class MultiTaskRewardsCfg:
    ...
    :class:`~isaaclab_tasks.manager_based.multi_task.mdp.commands.multitask.multi_task_cfg.MultiTaskCfg.TrackingTaskCfg`
    ...
    :func:`~isaaclab_tasks.manager_based.multi_task.mdp.commands.multitask.reward_composer.multiplicative_terminal_reward`.
