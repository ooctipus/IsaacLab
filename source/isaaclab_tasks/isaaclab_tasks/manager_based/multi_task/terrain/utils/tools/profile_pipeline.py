...
def main():
    ...
    tcfg = importlib.import_module("isaaclab_tasks.manager_based.multi_task.terrain.terrains")
    terrain_mod = sys.modules.get("isaaclab_tasks.manager_based.multi_task.terrain.terrains.terrain_cfg", tcfg)
