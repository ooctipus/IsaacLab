...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point": "isaaclab_tasks.manager_based.multi_task.position_env_cfg:LocomotionPositionCommandEnvCfg",
        "rsl_rl_cfg_entry_point": "isaaclab_tasks.manager_based.multi_task.terrain.config.rsl_rl_cfg:PositionRunnerCfg",
    },
)
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": "isaaclab_tasks.manager_based.multi_task.multi_task_env_cfg:MultiTaskEnvCfg",
        ...
        "rsl_rl_cfg_entry_point": (
            "isaaclab_tasks.manager_based.multi_task.terrain.config.rsl_rl_cfg:MultiTaskLocomotionPPORunnerCfg"
        ),
    },
)
