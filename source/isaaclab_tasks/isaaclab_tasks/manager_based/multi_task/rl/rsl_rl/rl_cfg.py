...
class RslRlMLPEncoderModelCfg(RslRlMLPModelCfg):
    ...
    class_name: str = "isaaclab_tasks.manager_based.multi_task.rl.rsl_rl.models.mlp_encoder_model:MLPEncoderModel"
...
class RslRlResidualMLPEncoderModelCfg(RslRlMLPEncoderModelCfg):
    """Configuration for encoder models with a residual MLP head."""

    class_name: str = (
        "isaaclab_tasks.manager_based.multi_task.rl.rsl_rl.models.residual_mlp_encoder_model:ResidualMLPEncoderModel"
    )
    """The model class name."""
    ...
    """Whether to apply LayerNorm before the residual head."""
...
class RslRlCommanderActorModelCfg(RslRlMLPModelCfg):
    ...
    class_name: str = (
        "isaaclab_tasks.manager_based.multi_task.rl.rsl_rl.models.commander_actor_model:CommanderActorModel"
    )
...
class RslRlTaskEasingActorModelCfg(RslRlMLPModelCfg):
    ...
    class_name: str = (
        "isaaclab_tasks.manager_based.multi_task.rl.rsl_rl.models.task_easing_actor_model:TaskEasingActorModel"
    )
