...
from isaaclab.sim import RigidBodyMaterialCfg, SphereCfg
...
class SceneCfg(InteractiveSceneCfg):
    ...
    object: RigidObjectCfg = RigidObjectCfg(
        ...
        spawn=sim_utils.MultiAssetSpawnerCfg(
            assets_cfg=[SphereCfg(radius=0.05, physics_material=RigidBodyMaterialCfg(static_friction=0.5))],
...
class DexsuiteReorientEnvCfg(ManagerBasedEnvCfg):
    ...
    variants = dexsuite_env_variants
