...
if TYPE_CHECKING:
    ...
    from isaaclab.sensors import TiledCamera, MultiMeshRayCasterCamera
...
class vision_camera(ManagerTermBase):
    ...
    def __init__(self, cfg, env: ManagerBasedRLEnv):
        ...
        self.sensor: TiledCamera | MultiMeshRayCasterCamera = env.scene.sensors[sensor_cfg.name]
    ...
    def show_collage(self, images: torch.Tensor):
        import numpy as np
