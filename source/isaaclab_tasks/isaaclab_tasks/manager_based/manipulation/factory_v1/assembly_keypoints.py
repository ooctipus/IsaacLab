...
class KeyPointsNistBoard:
    bolt_m16: Offset = Offset(pos=(0.04715, -0.3416, 0.0160), quat=(1.0, 0.0000, 0.0000, 0.0000))
    hole_8mm: Offset = Offset(pos=(0.3473, -0.1164, -0.0001), quat=(0.7071, -0.7071, 0.0000, 0.0000))
    gear_base: Offset = Offset(pos=(0.0474, -0.1713, -0.0002), quat=(0.7071, -0.7071, 0.0000, 0.0000))
    small_gear: Offset = Offset(pos=(0.0474, -0.1713, -0.0002), quat=(0.7071, -0.7071, 0.0000, 0.0000))
    medium_gear: Offset = Offset((0.0459, -0.1714, -0.0002), quat=(0.73566, -0.67736, 0.0000, 0.0000))
    large_gear: Offset = Offset(pos=(0.0474, -0.1713, -0.0002), quat=(0.7071, -0.7071, 0.0000, 0.0000))
...
class KeyPointsMediumGear:
    ...
    grasp_point: Offset = Offset(pos=(0.02025, 0.0, 0.0175), quat=(0.0, 0.0, -0.70711, 0.70711))
    grasp_diameter: float = 0.03
