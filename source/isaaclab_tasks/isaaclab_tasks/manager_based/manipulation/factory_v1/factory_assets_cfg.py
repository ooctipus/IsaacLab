...
SMALL_GEAR_CFG: RigidObjectCfg = RigidObjectCfg(
    ...
    spawn=sim_utils.UsdFileCfg(
        ...
        usd_path=f"{LOCAL_ASSET_PATH_DIR}/Props/NIST/gear_small_low_poly.usd",
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            solver_position_iteration_count=192,
            solver_velocity_iteration_count=1,
...
LARGE_GEAR_CFG: RigidObjectCfg = RigidObjectCfg(
    ...
    spawn=sim_utils.UsdFileCfg(
        ...
        usd_path=f"{LOCAL_ASSET_PATH_DIR}/Props/NIST/gear_large_low_poly.usd",
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            solver_position_iteration_count=192,
            solver_velocity_iteration_count=1,
...
GEAR_BASE_CFG: RigidObjectCfg = RigidObjectCfg(
    ...
    spawn=sim_utils.UsdFileCfg(
        ...
        usd_path=f"{LOCAL_ASSET_PATH_DIR}/Props/NIST/gear_base_low_poly.usd",
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            kinematic_enabled=True,
            solver_position_iteration_count=192,
...
MEDIUM_GEAR_CFG: RigidObjectCfg = RigidObjectCfg(
    ...
    spawn=sim_utils.UsdFileCfg(
        ...
        usd_path=f"{LOCAL_ASSET_PATH_DIR}/Props/NIST/gear_medium_low_poly.usd",
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            solver_position_iteration_count=192,
            solver_velocity_iteration_count=1,
