...
@configclass
class DexsuiteKukaInspirePPOBaseRunnerCfg(RslRlOnPolicyRunnerCfg):
...
@configclass
class DexsuiteKukaInspirePPORunnerCfg(PresetCfg):
    default = DexsuiteKukaInspirePPOBaseRunnerCfg().replace(
        experiment_name="dexsuite_kuka_inspire",
    ...
    single_camera = DexsuiteKukaInspirePPOBaseRunnerCfg().replace(
        experiment_name="dexsuite_kuka_inspire_single_camera",
    ...
    duo_camera = DexsuiteKukaInspirePPOBaseRunnerCfg().replace(
        experiment_name="dexsuite_kuka_inspire_duo_camera",
        obs_groups={
