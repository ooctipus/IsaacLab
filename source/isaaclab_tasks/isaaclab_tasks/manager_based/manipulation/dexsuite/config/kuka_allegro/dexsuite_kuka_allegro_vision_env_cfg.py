...
class KukaAllegroSingleTiledCameraSceneCfg(kuka_allegro_dexsuite.KukaAllegroSceneCfg):
    ...
    base_camera = TiledCameraCfg(
        ...
        offset=TiledCameraCfg.OffsetCfg(
            pos=(0.57, -0.8, 0.5),
            rot=(0.6124, 0.6124, 0.3536, 0.3536),
            convention="opengl",
        ),
        data_types=MISSING,
    ...
    def __repr__(self):
        # Custom repr to avoid accessing deleted fields
        return f"{self.__class__.__name__}(base_camera={self.base_camera!r})"
...
class KukaAllegroDuoTiledCameraSceneCfg(KukaAllegroSingleTiledCameraSceneCfg):
    ...
    def __repr__(self):
        return f"{self.__class__.__name__}(base_camera={self.base_camera!r}, wrist_camera={self.wrist_camera!r})"
