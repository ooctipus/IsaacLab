...
import isaaclab_assets.robots.spot as spot
...
@configclass
class SpotWithArmLocomotionPositionCommandEnvCfg(SpotEnvMixin, position_env_cfg.LocomotionPositionCommandEnvCfg):
    pass
