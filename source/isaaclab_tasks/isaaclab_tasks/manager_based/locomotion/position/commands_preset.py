...
class CommandsPresetCfg(PresetCfg):
    ...
    all_commands = {
        "lin_vel_cmd": RelativeStateCommandCfg.VelocityCommands(
            ...
            ang_vel_x=None, ang_vel_y=None, ang_vel_z=(-0.2, 0.2), duration=(0.05, 4.0),
        ),
        ...
        "terrain_position_cmd": RelativeStateCommandCfg.TerrainCommands(
            ...
            roll=(-0.0, 0.0), pitch=(-0.0, 0.0), yaw=None, duration=(0.05, 2.0),
        ),
        "terrain_pose_cmd": RelativeStateCommandCfg.TerrainCommands(
            pos_x=(-0.0, 0.0), pos_y=(-0.0, 0.0), pos_z=(-0.0, 0.0),
            roll=(-0.0, 0.0), pitch=(-0.0, 0.0), yaw=(-3.14, 3.14), duration=(0.05, 2.0),
        ),
        "terrain_stand_up_cmd": RelativeStateCommandCfg.TerrainCommands(
            pos_x=None, pos_y=None, pos_z=None,
            roll=(-0.0, 0.0), pitch=(-0.0, 0.0), yaw=None, duration=(0.05, 4.0),
        ),
