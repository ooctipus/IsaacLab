...
class FeatureExtractor:
    ...
    def _preprocess_images(
        ...
        Returns:
            tuple[torch.Tensor | None, torch.Tensor | None, torch.Tensor | None, torch.Tensor | None]:
            Preprocessed RGB, depth, segmentation, and albedo images
        """
        ...
        return rgb_img, depth_img, segmentation_img, albedo_img
    ...
    def step(
        ...
        rgb_img, depth_img, segmentation_img, albedo_img = self._preprocess_images(
            rgb_img, depth_img, segmentation_img, albedo_img
        )

        if self.cfg.write_image_to_file:
            self._save_images(rgb_img, depth_img, segmentation_img, albedo_img)
