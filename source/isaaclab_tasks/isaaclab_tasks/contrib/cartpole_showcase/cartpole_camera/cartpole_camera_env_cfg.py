...
class CartpoleCameraEnvCfg(DirectRLEnvCfg):
    ...
    Each showcase variant below overrides :attr:`observation_space` and :attr:`action_space`
    to demonstrate a specific space layout.
    """
...
class BoxBoxEnvCfg(CartpoleCameraEnvCfg):
    ...
    * Action space (``~gymnasium.spaces.Box`` with shape (1,))
    ...
    # spaces
    observation_space = spaces.Box(low=float("-inf"), high=float("inf"), shape=(100, 100, 3))
    ...
    observation_space = spaces.Dict(
        {
            ...
            "camera": spaces.Box(low=float("-inf"), high=float("inf"), shape=(100, 100, 3)),
        }
...
class TupleBoxEnvCfg(CartpoleCameraEnvCfg):
    ...
    * Action space (``~gymnasium.spaces.Box`` with shape (1,))
    ...
    observation_space = spaces.Tuple(
        (
            spaces.Box(low=float("-inf"), high=float("inf"), shape=(100, 100, 3)),
