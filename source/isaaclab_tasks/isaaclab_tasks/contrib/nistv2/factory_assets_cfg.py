...
ASSEMBLY_CONTACT_MATERIAL_CFG = preset(
    default=_ASSEMBLY_CONTACT_MATERIAL,
    newton_mjwarp=_ASSEMBLY_CONTACT_MATERIAL,
)
...
ROBOT_CONTACT_MATERIAL_CFG = preset(default=_ROBOT_CONTACT_MATERIAL, newton_mjwarp=_ROBOT_CONTACT_MATERIAL)
