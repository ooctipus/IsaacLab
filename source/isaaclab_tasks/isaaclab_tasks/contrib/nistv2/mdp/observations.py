...
class target_asset_pose_in_root_asset_frame(ManagerTermBase):
    ...
    def __init__(self, cfg: ObservationTermCfg, env: ManagerBasedEnv):
        ...
        self._kernel_inputs = (
            target_poses,
            root_poses,
            variants.variant_ids_warp,
            variants.offset_warp(cfg.params.get("target_asset_offset", _IDENTITY_OFFSET)),
            variants.offset_warp(cfg.params.get("root_asset_offset", _IDENTITY_OFFSET)),
