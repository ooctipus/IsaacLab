...
rather than a named variant -- ``IsaacContrib-Factory-V2-Franka`` needs no
...
from ..factory_assets_cfg import FRANKA_PANDA_NEWTON_CFG
...
_FRANKA_NEWTON_CFG = FRANKA_PANDA_NEWTON_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
RobotArticulationCfg.default = _FRANKA_NEWTON_CFG
