...
class MeshClearanceCfg(ManagerTermBaseCfg):
    ...
    against the robot's collision meshes with Warp signed-distance queries. The implementation
    is referenced by name and resolved at play, so importing this config pulls no
