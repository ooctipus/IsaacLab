...
def test_runtime_asset_types_use_backend_independent_bases() -> None:
    """Runtime validation accepts concrete assets produced by any physics backend."""
    ...
    assert reset_state_writer._runtime_asset_types() == (BaseArticulation, BaseRigidObject)
