...
See :mod:`..robot_presets` for the robot registry and how to add new robots.
"""
...
# ``..robot_presets`` classes at import time, and ``presets=franka`` cannot resolve until
# it has run. Keeping it here rather than in ``robot_presets`` leaves that module free of
