...
"""Read phase for primitive_graph_local — fills the unified buffer from typed slabs."""
...
def fill_unified_buffer_warp(command: MultiTaskCommandWarp, plan: PrimitiveGraphLocalPlan) -> None:
