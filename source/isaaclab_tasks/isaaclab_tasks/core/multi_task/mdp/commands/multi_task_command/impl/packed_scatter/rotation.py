...
"""Body-frame command rotation for the packed_scatter backend."""
...
def rotate_canonical_slots_to_body_frame_warp(command: MultiTaskCommandWarp, plan: PackedScatterPlan) -> None:
