...
the base environment / scene references inline. Per-robot modules under
:mod:`.config` (e.g. :mod:`.config.franka_factory_cfg`) populate their own field
on these classes at import time, and the preset resolver then substitutes the
picked field at every consumption site.
