    ...
    def command_terms(self, group: str, robot: RobotModuleCfg) -> dict[str, object]:
        ...
        return {
            cmd_name: mdp.PoseCommandCfg(
                asset_cfg=SceneEntityCfg(asset_name, body_names=[ee_body], groups=[group]),
    ...
    def task_obs_terms(self, group: str, robot: RobotModuleCfg) -> dict[str, ObsTerm]:
        ...
        terms: dict[str, ObsTerm] = {
            "object_pos": ObsTerm(
                ...
                params={
                    "robot_cfg": SceneEntityCfg(asset_name, groups=[group]),
                    "object_cfg": SceneEntityCfg(cube_name, groups=[group]),
                },
            ),
        ...
        return {
            "commands": (
                ...
                TermCfg(
                    ...
                    params={
                        "asset_cfg": SceneEntityCfg(asset_name, groups=[group]),
                        "command_name": cmd_name,
                    },
                ),
            ),
    ...
    def reset_events(self, group: str, robot: RobotModuleCfg) -> dict[str, EventTerm]:
        ...
        return {
            f"{group}_reset_lift_object_default": EventTerm(
                ...
                mode="reset",
                params={
                    "asset_cfgs": [SceneEntityCfg(cube_name, groups=[group])],
                },
            ),
