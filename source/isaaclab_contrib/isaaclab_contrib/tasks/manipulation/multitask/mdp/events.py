...
def reset_to_default(
    ...
    *,
    ...
    for asset_cfg in asset_cfgs:
        env_ids_filtered, view_ids = layout.filter_reset_ids(asset_cfg.name, env_ids)
...
def reset_joints(
    ...
    *,
    ...
    env_ids, view_ids = layout.filter_reset_ids(asset_cfg.name, env_ids)
    if env_ids.numel() == 0:
        return
...
def reset_object_uniform(
    ...
    *,
    ...
    env_ids, view_ids = layout.filter_reset_ids(object_cfg.name, env_ids)
    if env_ids.numel() == 0:
        return
