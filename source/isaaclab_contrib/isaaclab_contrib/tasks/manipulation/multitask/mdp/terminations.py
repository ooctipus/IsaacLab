...
def object_height_below_minimum(
    ...
    *,
    ...
    height = wp.to_torch(rigid_object.data.root_pos_w)[object_cfg.group_ids, 2]
...
def cabinet_drawer_opened(
    ...
    *,
    ...
    drawer_pos = wp.to_torch(cabinet.data.joint_pos)[cabinet_asset_cfg.group_ids, cabinet_asset_cfg.joint_ids]
