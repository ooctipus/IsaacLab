    ...
    def scatter_obs_terms(self, group: str) -> dict[str, tuple[int | None, TermCfg]]:
        return {
            "ee_pose": (
                ...
                TermCfg(
                    func=mdp.ee_pose,
                    params={"asset_cfg": SceneEntityCfg("ur10_robot", body_names=["ee_link"], groups=[group])},
                ),
            ),
        }
        ...
        return {
            "ur10_reset_to_default": EventTerm(
                ...
                params={
                    ...
                    "asset_cfgs": [SceneEntityCfg("ur10_robot", groups=[group])],
                },
            ),
            "ur10_reset_joints": EventTerm(
                ...
                params={
                    ...
                    "asset_cfg": SceneEntityCfg("ur10_robot", joint_names=[".*"], groups=[group]),
                },
            ),
        }
