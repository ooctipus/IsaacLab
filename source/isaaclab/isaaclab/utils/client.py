...
def stat(path: str) -> Tuple[Result, Optional[Dict[str, Any]]]:
    """Check whether a remote or local file exists."""
...
def copy(
    ...
    """Copy remote->local or local->S3 (minimal set we care about)."""
...
async def download_usd_with_references(
    ...
    """Download a root USD and all referenced assets."""
...
def download_usd_with_references_sync(
    ...
    """Sync wrapper for download_usd_with_references."""
