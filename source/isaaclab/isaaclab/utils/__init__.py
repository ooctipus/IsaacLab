...
# Import configclass directly — its name matches its submodule name, which
# confuses lazy_loader's attribute-caching logic (the import machinery resets
# the parent attribute to the submodule object after each submodule import).
# configclass.py only depends on stdlib and local utils, so eager import is fine.
