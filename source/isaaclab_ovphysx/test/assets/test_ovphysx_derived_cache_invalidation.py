...
_ALL_FIELDS = _POSE_DERIVED + (
    ...
    "body_com_state_w",
    "root_state_w_buf",
    "root_link_state_w_buf",
    "root_com_state_w_buf",
    "body_state_w_buf",
    "body_link_state_w_buf",
    "body_com_state_w_buf",
    "body_com_jacobian_w",
...
def test_pose_reset_invalidates_cached_derived_properties(data_cls, derived) -> None:
...
def test_velocity_reset_invalidates_cached_body_frame_velocities(data_cls) -> None:
    data = _primed(data_cls)
