...
class PbtCfg:
    ...
    """Lower bound of multiplicative change factor (sampled in [change_min, change_max])."""

    change_max: float = 2.0
    """Upper bound of multiplicative change factor (sampled in [change_min, change_max])."""
